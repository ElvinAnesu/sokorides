...
export async function addClientDetails(params, formData) {
	...
	revalidatePath(
		`/dashboard/rent-to-buy/createnew/${_id}/documents`
	);
	redirect(`/dashboard/rent-to-buy/createnew/${_id}/documents`);
}
export async function addLeaseDocuments(_id, documentUrl, documentType) {
	...
	revalidatePath(`/dashboard/rent-to-buy/${_id._id}`);
	redirect(`/dashboard/rent-to-buy/${_id._id}`);
}
...
export async function updateDownPayment(
	...
	revalidatePath(`/dashboard/rent-to-buy/${_id}`);
	redirect(`/dashboard/rent-to-buy/${_id}`);
}
...
export async function deleteLeaseDocument(leaseId, doc) {
	try {
		...
		revalidatePath(`/dashboard/rent-to-buy/${leaseId}`);
