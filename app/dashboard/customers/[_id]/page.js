...
import { EyeOpenIcon, TrashIcon, ArrowLeftIcon } from "@radix-ui/react-icons";
...
export default function ViewCustomer({ params }) {
  ...
  return (
        ...
        <div className="flex items-center gap-2">
          <button className="border border-purple-900 rounded-full p-1 text-purple-900"
          onClick={()=>router.back()}><ArrowLeftIcon className="w-5 h-5" /></button>
					<h1 className="text-sm font-semibold">Customer Info</h1>
				</div>
				<button
					className="rounded bg-purple-900 text-white text-sm items-center jusitfy-center px-4 border rounded py-2"
			...
			<div className="w-full flex flex-col bg-gray-200">
				...
				<table className="w-full">
					<tbody>
						<tr className="text-xs font-semibold bg-purple-900 text-white">
