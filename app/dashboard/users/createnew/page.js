    ...
    return(
        <div className="w-full h-full flex flex-col gap-4 p-4 bg-gray-200 rounded">
            <div className="flex gap-2 flex items-center gap-2">
                <button className="border border-purple-900 p-1 rounded-full text-purple-900" onClick={()=> router.back()}><ArrowLeftIcon className="w-5 h-5"/></button>
            ...
            <form className="flex flex-col md:grid md:grid-cols-3" onSubmit={(e)=>createUser(e)}>
                <div className="flex flex-col p-2">
                    <h1 className="text-xs ">First Name</h1>
                    <input className="border border-black rounded bg-transparent w-full p-2 test-sm"
                ...
                <div className="flex flex-col p-2">
                    ...
                    <select className="border border-black rounded bg-transparent w-full p-2 test-sm" 
                ...
                <div></div>
                <div className="flex flex-col p-2">
                    <button className="w-full bg-purple-900 text-white rounded p-2">Create</button>
                </div>
            </form>}
        </div>
    )
