...
export default function EditInvoiceForm({ customers, invoice }) {
				...
				>
					...
					<div className="flex gap-4">
						<div className="flex flex-col gap-1">
							<h1 className="text-xs font-semibold">Download invoice(pdf)</h1>
							<Link
								href={invoice.invoiceUrl}
								className="flex items-center justify-center border border-black text-black rounded text-purple-900 rounded p-1 max-w-32 shadow"
							>
								View
							</Link>
						</div>
