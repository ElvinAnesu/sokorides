...
import { DashboardIcon, ListBulletIcon, RocketIcon, PersonIcon, AvatarIcon, ExitIcon, CardStackIcon, IdCardIcon } from "@radix-ui/react-icons"
    ...
    return (
			<div className="flex flex-col w-full h-full p-4 shadow rounded bg-gray-200">
				<ul className="flex flex-col gap-4 text-sm">
					<li
						className={`p-2 rounded hover:bg-gray-900 hover:text-white ${
					...
					<li
						className={`p-2 rounded hover:bg-gray-900 hover:text-white ${
							pathname === "/dashboard/cars" ? "bg-gray-900 text-white" : ""
						}`}
					>
					...
					<li
						className={`p-2 rounded hover:bg-gray-900 hover:text-white ${
							pathname === "/dashboard/payments" ? "bg-gray-900 text-white" : ""
						}`}
					>
					...
					<li
						className={`p-2 rounded hover:bg-gray-900 hover:text-white ${
							pathname === "/dashboard/users" ? "bg-gray-900 text-white" : ""
						}`}
					>
